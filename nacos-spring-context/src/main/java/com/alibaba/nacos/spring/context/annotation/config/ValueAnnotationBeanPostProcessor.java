 ...
 * @since 0.3.4
 */
public abstract class ValueAnnotationBeanPostProcessor<A extends Annotation> extends AnnotationInjectedBeanPostProcessor<A>
    ...
    protected Map<String, List<NacosValueTarget>> placeholderNacosValueTargetMap
    ...
    protected <K, V> void put2ListMap(Map<K, List<V>> map, K key, V value) {
    ...
    protected void setMethod(NacosValueTarget nacosValueTarget, String propertyValue) {
        ...
        try {
            method.invoke(nacosValueTarget.bean, ObjectUtils.convertIfNecessary(beanFactory, method, propertyValue));
    ...
    protected void setField(final NacosValueTarget nacosValueTarget, final String propertyValue) {
        ...
        try {
            ...
            field.set(bean, ObjectUtils.convertIfNecessary(beanFactory, field, propertyValue));
    ...
    protected abstract void doWithAnnotation(String beanName, Object bean, A annotation, int modifiers, Method method,
                                  Field field);
