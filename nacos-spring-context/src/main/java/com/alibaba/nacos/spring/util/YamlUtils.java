...
public abstract class YamlUtils {
    ...
    private static boolean process(MatchCallback callback, Yaml yaml, String content) {
        int count = 0;
    ...
    private static boolean process(Map<String, Object> map, MatchCallback callback) {
    ...
    private static class MapAppenderConstructor extends Constructor {
